...
QUESTIONS = [
    ...
    "Als je morgen overal ter wereld wakker kon worden, waar zou dat zijn?",
    ...
    "Over welk onderwerp kun je urenlang praten?",
    ...
    "Welke hobby of activiteit zou je graag eens willen proberen?",
